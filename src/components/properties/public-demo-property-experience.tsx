...
export function PublicDemoPropertyExperience({
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-14 pb-12 pt-2 lg:space-y-16 lg:pb-16 lg:pt-4">
      ...
      >
        <dl className="grid gap-x-8 gap-y-2 sm:grid-cols-2 lg:max-w-4xl lg:gap-x-12">
